...
struct ContentView: View {
    ...
    let friends = [
        ...
        Friend(emoji: "🌎", color: Color.wavelengthBlue, uid: "1", firstName: "Carson", lastName: "Guillemet", goals: "To just do it.", interests: ["Programming", "Travelling", "Boxing"], scorePercentage: 27, scoreAnalysis: "Amazing friendship!", tokenCount: -7, memoryCount: 47)
    ]
