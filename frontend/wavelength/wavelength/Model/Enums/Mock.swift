...
enum Mock {
    ...
    static let user: User = User(uid: "1", emoji: "🌎", color: Color.wavelengthBlue, firstName: "Doeun", lastName: "Kwon", username: "billthemuffer", email: "bkwon38@gmail.com", password: "Abc123", goals: "I aspire to be an entrepreneur who builds clever apps that address underserved problems in society. I love working out my body so while I build out apps, I still want to achieve athletic milestones, like running a marathon and building a beautiful physique.", interests: ["Programming", "Designing", "Boxing", "Muay Thai", "Running", "EDM", "Nature"], scorePercentage: 63, tokenCount: 25, memoryCount: 135, values: ["Discipline", "Hardwork", "Growth", "Integrity", "Learning", "Positivity"])
    
    static let friend: Friend = Friend(fid: "1", emoji: "📀", color: Color.wavelengthYellow, firstName: "Kael", lastName: "Ramirez", goals: "He aspires to become a renowned architect, designing innovative and sustainable structures that shape the urban landscape. Additionally, Kael seeks to master the art of photography, capturing the beauty of the world through his lens.", interests: ["Architecture", "Photography", "Technology", "Music"], scorePercentage: 75, scoreAnalysis: "", tokenCount: 12, memoryCount: 67, values: ["Learning", "Growth", "Integrity", "Kindness", "Perspective"])
    
    static let friends: [Friend] = [
        Friend(fid: "1", emoji: "📀", color: Color.wavelengthYellow, firstName: "Kael", lastName: "Ramirez", goals: "He aspires to become a renowned architect, designing innovative and sustainable structures that shape the urban landscape. Additionally, Kael seeks to master the art of photography, capturing the beauty of the world through his lens.", interests: ["Architecture", "Photography", "Technology", "Music"], scorePercentage: 75, scoreAnalysis: "", tokenCount: 12, memoryCount: 67, values: ["Learning", "Growth", "Integrity", "Kindness", "Perspective"]),
    ...
    static let memory: Memory = Memory(mid: "1", date: Date(), title: "Text message during my Asia trip 2024 to Tokyo, Japan.", content: "He asked me to hang out after my Asia trip. I thought it was quite nice that he thought of me while I was on my trip because it’s easy to forget these things!", tokens: 2)
