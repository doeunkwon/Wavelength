        ...
        NavigationStack {
            ZStack {
                ...
                .navigationBarItems(leading: Button(action: { dismiss() }) {
                    ...
                    NavigationLink(destination: MemoryFormView(memory: memory, leadingButtonContent: AnyView(DownButtonView()), buttonConfig: MemoryFormTrailingButtonConfig(title: Strings.Actions.save, action: memoryViewModel.completion), navTitle: Strings.Memory.edit)) {
